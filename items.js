...
const ITEM_TEMPLATES = {
    ...
    corpse_supervisor: {
        id: "corpse_supervisor",
        name: "监工的尸体",
        type: "misc",
        desc: "监工的尸体倒在血泊中，口袋里似乎还有些东西。可以拾取后在背包中搜刮。",
        loot: ["herb", "bread"]
        // 监工不可肢解
    },
    ...
    mansion_key: {
        ...
        name: "伯爵宅邸钥匙",
        type: "important",
        desc: "一把精致的银质钥匙，钥匙柄上雕刻着复杂的贵族纹章。这是进入桑华山伯爵私人宅邸的唯一凭证。"
    },
    // 伯爵宅邸大门（可交互，使用钥匙进入）
    mansion_gate_door: {
    ...
    liana_hand: {
        ...
        name: "莉娅娜的手",
        type: "limb",
        desc: "莉娅娜的手，曾经紧握长剑斩杀敌人。手指修长却布满老茧，虎口处有长期握剑留下的厚茧。可以作为烹饪材料。一只强健却性感的手，属于女骑士莉娅娜·冯·斯特兰。手指粗壮有力，指关节突出，手指上涂着的亮红色指甲油表明了断手主人少女的身份。掌心布满厚厚的剑茧，摸上去依旧带着粗糙的摩擦感。手背青筋凸起，皮肤紧致。断口露出白色的掌骨与发达的粉红肌肉，鲜血缓慢渗出，让这双曾握剑的手现在只剩淫靡的血润光泽。",
        usable: true,
        customAction: true,
        cookable: true,
        ingredientType: "hand",
    ...
    isabella_leg: {
        ...
        name: "伊莎贝拉的腿",
        type: "limb",
        desc: "一条修长丰满的腿，属于伯爵夫人伊莎贝拉·冯·兰德尔。被黑色丝袜紧紧包裹，大腿饱满圆润，小腿线条流畅，充满弹性。丝袜被鲜血浸透后贴在皮肤上，勾勒出诱人的曲线。断面露出粗壮的腿骨与丰厚的粉红肌肉，鲜血顺着大腿根部缓缓流下，把黑色丝袜染成妖艳的红黑。",
        cookable: true,
        ingredientType: "leg",
    ...
    isabella_arm: {
        ...
        name: "伊莎贝拉的手臂",
        type: "limb",
        desc: "一条圆润丰满的手臂，属于伯爵夫人伊莎贝拉·冯·兰德尔。皮肤白皙紧致，线条柔美却带着成熟女性的肉感。手臂内侧特别细嫩。由于长期被紧身衣物包裹，这条手臂保留着一种被精心养护的奢靡质感，摸上去软弹而温暖，仿佛随时能溢出成熟女性的甜腻。断面露出粉红的肌肉层与白色臂骨，这条曾经只用来拥抱伯爵或在丝绸床单上自慰的手臂，现在只是一个淫靡的残肢。",
        cookable: true,
        ingredientType: "arm",
...
const CORPSE_TEMPLATE_MAP = {
    ...
    liana_wounded: 'corpse_liana',   // 伤痕累累的莉娅娜
